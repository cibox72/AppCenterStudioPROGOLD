...
function iniettaCSSGlobale(tema) {
  ...
  var css = '';
  css += 'body { background: ' + tema.bg + ' !important; color: ' + tema.textMain + ' !important; }';
  css += '.studio-name, .studio-id, .page-header h1, .card-title, .module-title, .dash-card .card-title, .section-header span { color: ' + tema.textMain + ' !important; }';
  css += '.top-bar, .branding-header, .page-header::before, .card::before, .dash-card::before, .section-header { background: ' + tema.pg + ' !important; }';
  css += '.page-header { background: ' + tema.cardBg + ' !important; }';
  ...
  css += '.card, .module-card, .dash-card, .service-item, .gallery-list-item, .order-item, .payment-card, .stat-card, .email-item, .template-card { background: ' + tema.cardBg + ' !important; color: ' + tema.textMain + ' !important; border-color: ' + tema.pl + ' !important; }';
  ...
  css += '.form-group label, .form-group input, .form-group select, .form-group textarea { color: ' + tema.textMain + ' !important; }';
  css += '.form-group input, .form-group select, .form-group textarea { background: ' + (tema.cardBg === '#ffffff' ? '#f8f9fa' : '#34495e') + ' !important; border-color: ' + tema.pl + ' !important; }';
  ...
  css += '.toast { border-left-color: ' + tema.p + ' !important; background: ' + tema.cardBg + ' !important; color: ' + tema.textMain + ' !important; }';
  css += '.spinner { border-top-color: ' + tema.p + ' !important; border-color: ' + tema.pl + ' ' + tema.pl + ' ' + tema.p + ' ' + tema.pl + ' !important; }';
  css += '.agenda-time { border-right-color: ' + tema.pl + ' !important; background: ' + (tema.cardBg === '#ffffff' ? '#f8f9fa' : '#34495e') + ' !important; color: ' + tema.textMain + ' !important; }';
  css += '.agenda-header { border-bottom-color: ' + tema.p + ' !important; }';
  css += '.agenda-container { border-color: ' + tema.pl + ' !important; background: ' + tema.cardBg + ' !important; }';
  ...
  css += '.cred-box, .info-box { background: ' + tema.pl + ' !important; border-color: ' + tema.p + ' !important; color: ' + tema.textMain + ' !important; }';
  ...
  css += '.ricevuta-stampa { border-color: ' + tema.p + ' !important; background: ' + tema.cardBg + ' !important; }';
  ...
  css += '.modal-content { background: ' + tema.cardBg + ' !important; color: ' + tema.textMain + ' !important; }';
  css += '.modal-header { border-bottom-color: ' + tema.pl + ' !important; }';
  css += '.modal-header h2 { color: ' + tema.pd + ' !important; }';
  css += '.close-modal { color: ' + tema.textMain + ' !important; }';
  ...
  css += '.card-subtitle { color: ' + tema.textMain + ' !important; opacity: 0.8 !important; }';
  ...
  css += '.ricevuta-stampa .ricevuta-data, .ricevuta-stampa .ricevuta-riga { background: ' + (tema.cardBg === '#ffffff' ? '#ffffff' : '#34495e') + ' !important; }';
  ...
  css += '.ricevuta-stampa .ricevuta-firma-linea { color: ' + tema.textMain + ' !important; }';
  ...
  css += '.task-completed .task-label { color: ' + tema.textMain + ' !important; opacity: 0.6 !important; }';
  css += '.empty-state, .loading { color: ' + tema.textMain + ' !important; }';
  css += '.footer-branding { color: ' + tema.textMain + ' !important; }';
  ...
  css += '.payment-card { border-color: ' + tema.pl + ' !important; background: ' + tema.cardBg + ' !important; }';
  css += '.payment-card.active { border-color: ' + tema.p + ' !important; background: ' + tema.pl + ' !important; }';
  css += '.slider { background-color: ' + tema.pl + ' !important; }';
  css += 'input:checked + .slider { background-color: ' + tema.p + ' !important; }';
  css += '.product-image { background: ' + tema.pl + ' !important; }';
  css += '.product-card { border-color: ' + tema.pl + ' !important; background: ' + tema.cardBg + ' !important; }';
  css += '.product-card:hover { border-color: ' + tema.p + ' !important; box-shadow: 0 12px 24px ' + tema.pl + ' !important; }';
  css += '.cart-sidebar { box-shadow: -4px 0 20px ' + tema.pl + ' !important; background: ' + tema.cardBg + ' !important; }';
  ...
  css += '.page-header { background: ' + tema.cardBg + ' !important; box-shadow: 0 10px 30px ' + tema.pl + ' !important; }';
  css += '.card, .module-card, .dash-card { background: ' + tema.cardBg + ' !important; box-shadow: 0 10px 30px ' + tema.pl + ' !important; }';
  ...
  css += '.service-name, .service-category { color: ' + tema.textMain + ' !important; }';
  ...
  css += '.template-card { border-color: ' + tema.pl + ' !important; background: ' + tema.cardBg + ' !important; }';
  css += '.template-desc { color: ' + tema.textMain + ' !important; opacity: 0.8 !important; }';
  css += '.gallery-nomi { color: ' + tema.textMain + ' !important; }';
  css += '.gallery-credentials { background: ' + tema.pl + ' !important; color: ' + tema.textMain + ' !important; }';
  css += '.mega-guide ol { color: ' + tema.textMain + ' !important; }';
  css += '.stat-label { color: ' + tema.textMain + ' !important; opacity: 0.8 !important; }';
  css += '.badge-attesa { background: ' + tema.pl + ' !important; color: ' + tema.pd + ' !important; }';
  css += '.task-label { color: ' + tema.textMain + ' !important; }';
  css += '.overall-progress { background: ' + tema.cardBg + ' !important; }';
